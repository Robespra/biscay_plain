...
<li><a style="color:#e05d4d;" href="http://twitter.com/home?status=Intéressant... http://www.elhacedor.soy" title="Partager cet article sur Twitter!" target="_blank" onclick="track('Click-social-footer-twitter','Click-social-footer-twitter')"><img class="lazy" src="<?php bloginfo('template_url'); ?>/images/social_twitter.svg"/></a></li>
...
</div><a href="http://www.elhacedor.soy/a-propos/" onclick="track('Click-social-footer-about','Click-social-footer-about')">A PROPOS</a>/<a href="http://www.elhacedor.soy/mentions-legales" onclick="track('Click-social-footer-tamis','Click-social-footer-tamis')">MENTIONS LEGALES</a>/<a href="http://www.elhacedor.soy/participer/" onclick="track('Click-social-footer-newsletter','Click-social-footer-newsletter')">PARTICIPER</a>/<a href="http://www.elhacedor.soy/newsletter_template/index.html" onclick="track('Click-social-footer-contact','Click-social-footer-contact')">NEWSLETTER</a>/<a href="http://www.elhacedor.soy/contact/" onclick="track('Click-social-footer-contact','Click-social-footer-contact')">CONTACT</a>
