...
<img class="logo-newsletter"src="<?php bloginfo('template_url'); ?>/images/logo_hero_unit_hp_v2.svg" alt="Logo Poïesis"/>
<p class="voulez-vous">Recevez chaque semaine 5 articles sélectionnés par nos soins.</p>
