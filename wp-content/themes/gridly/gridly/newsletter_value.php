...
<div id="newsletterform">
      <div class="wrap">
          <h3>Découvrez comment fonctionne votre cerveau et améliorez votre créativité.</h3>
          ...
          <form action="<?php echo get_template_directory_uri(); ?>/newsletter_sign_up_send.php" method="post" id="newsletter" name="newsletter">
              <input type="email" name="signup-email" id="signup-email" value="" placeholder="Entrez votre email pour vous abonner" autofocus/>
              <input type="submit" value="S'inscrire" name="signup-button" id="signup-button">
