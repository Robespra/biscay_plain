...
<div id="newsletterform">
      <div class="wrap">
          ...
          <p class=small>Recevez chaque samedi matin<bold> 5 articles sur la créativité sélectionnés par nos soins parmi toutes les publications en ligne.</bold> Vous êtez libre de vous désinscrire lorsque vous le souhaitez. <a href="http://www.biscaypla.in/newsletter_template/index.html" target="_blank" style="text-decoration:underline" onclick="track('Click-newsletter-log-exemple','Click-newsletter-log-exemple')">Voir un exemple</a></p>
