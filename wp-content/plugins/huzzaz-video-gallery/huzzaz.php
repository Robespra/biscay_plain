...
function huzzaz_func( $atts ) {
    ...
    if( !$pro ) {
        ...
        $gallery = '<div class="' . esc_attr($class) . '"><iframe class="hzframe" src="' . esc_url($src) . '" height="0" width="100%" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen allowTransparency="true"></iframe><script src="https://huzzaz.com/js/hzframe.js"></script></div>';
    } else {
        if ( !$popoutlink ) {
            if ( $layout != "card" ){
